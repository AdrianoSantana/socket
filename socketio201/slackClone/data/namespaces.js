...
const mozNs = new Namespace(1,'FIREFOX','https://www.mozilla.org/media/img/logos/firefox/logo-quantum.9c5e96634f92.png','/mozilla')
const linuxNs = new Namespace(2,'PINGUIN','https://upload.wikimedia.org/wikipedia/commons/a/af/Tux.png','/linux')
